-- Based on https://github.com/linkarzu/dotfiles-latest/blob/main/neovim/neobean/lua/config/keymaps.lua

local M = {
  --
}

M.update_markdown_toc = function(h2)
  ...
  -- Inserts H2 heading and <!-- toc --> at the appropriate position
  if not toc_exists then
    ...
    -- Insert the TOC inside a H2 heading right below the main H1 at the top lamw25wmal
    vim.api.nvim_buf_set_lines(bufnr, insertion_line, insertion_line, false, { h2, "<!-- toc -->" })
  end
